...
import d3.soar.UserData.User;
    ...
    /// @brief Represents the list of all the Users
    /// @see User
public class Users {
    public List<User> users;

    ///@brief Constructs a new users object with default values
    public Users() {
    }
...
///@brief Reads users from a file and populates the users list (not implemented)
    ...
    /// @brief Returns a string representation of the list of Users
