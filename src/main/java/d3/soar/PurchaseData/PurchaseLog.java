...
///@brief Represents a purchase log in the system, containing lists of purchases or bulk purchases
///@details The PurchaseLog will usually include either a list of Purchases or BulkPurchases, but not both at the same time
///@see Purchase
/// @see BulkPurchase
...
///@brief Constructs a new purchase log with default values
    public PurchaseLog() {
    }
...
///@brief Constructs a new purchase log with the specified lists of purchases and bulk purchases
    ...
    /// @return A string representation of the Purchase Log object
    @Override
